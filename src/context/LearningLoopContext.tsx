...
export const DEFAULT_CAREER_PATHS: CareerPath[] = [
  {
    ...
    category: "Support",
    description:
      "Master de-escalation, empathy under pressure, and fast issue resolution.",
    matchScore: 96,
  ...
  },
  {
    ...
    category: "Helpdesk",
    description:
      "Diagnose technical issues, manage tickets, and communicate solutions clearly.",
    matchScore: 94,
    startingClassId: "class-1",
    startingScenarioId: "sim-1",
    targetJobRoles: [
  ...
  },
  {
    ...
    category: "Systems",
    description:
      "Resolve network outages, system security, and urgent incident escalations.",
    matchScore: 91,
  ...
  },
  {
    ...
    category: "Healthcare",
    description:
      "Coordinate patient care, compassionate crisis triage, and HIPAA protocols.",
    matchScore: 93,
    startingClassId: "class-1",
