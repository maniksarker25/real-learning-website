          ...
          <div className="p-6 space-y-6">
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  disabled={activeLessonIndex === currentClass.lessons.length - 1}
                  onClick={() =>
            ...
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              <div>
                ...
                <p className="text-xs text-white/60">
                  Measure your conceptual understanding before starting practical simulations.
                </p>
              </div>
                        ...
                        return (
                          <button
                            ...
                            className={cn(
                              ...
                              quizSubmitted && isCorrect && "bg-emerald-500/20 border-emerald-500 text-emerald-300",
                              quizSubmitted && isSelected && !isCorrect && "bg-rose-500/20 border-rose-500 text-rose-300"
                            )}
                          >
