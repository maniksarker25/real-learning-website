...
export default memo(function HowRealLearningWorks() {
  ...
  return (
    <section className="relative w-full py-20 sm:py-28 bg-orange-50 text-white overflow-hidden select-none border-t border-white/[0.08]">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 sm:mb-16">
          <div className="max-w-2xl space-y-3.5">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-extrabold tracking-tight text-black leading-[1.15] uppercase">
              Learn by{" "}
            ...
            <p className="text-sm sm:text-base text-gray-900/60 font-medium leading-relaxed max-w-xl">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-1.5 p-1 rounded-full bg-black/[0.04] border border-white/10">
            ...
            <div className="flex items-center gap-1.5">
              <button
                ...
                className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-black/70 hover:text-black hover:bg-white/10 disabled:opacity-25 disabled:hover:bg-white/5 cursor-pointer transition-all"
                title="Previous step"
              >
